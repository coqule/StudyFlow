...
export function BloqueCalendario({ bloque, posicion }: BloqueCalendarioProps) {
  ...
  return (
    <article
      ...
      className="absolute inset-x-0.5 overflow-hidden rounded-sm bg-surface-container-high px-xs py-0.5 text-left"
      style={{
        top: posicion.top,
